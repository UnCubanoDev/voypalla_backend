...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    driverID: Schema.Attribute.Integer;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    type: Schema.Attribute.Enumeration<['pasajero', 'taxista']> &
      Schema.Attribute.DefaultTo<'pasajero'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Commission: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    InitialWalletBalance: Schema.Attribute.Decimal &
    ...
    > &
      Schema.Attribute.Private;
    NightCommission: Schema.Attribute.Integer;
    NightPricePerKm: Schema.Attribute.Decimal;
...
export interface ApiDriverReviewDriverReview
  extends Struct.CollectionTypeSchema {
...
export interface ApiDriverDriver extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    availability: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    ci: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_location: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::geodata.geojson',
        {
          info: true;
    ...
    licence: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::driver.driver'>;
    ...
    vehicle_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiProposalProposal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    porposal_status: Schema.Attribute.Enumeration<
...
export interface ApiTripTrip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status_trip: Schema.Attribute.Enumeration<
      ['Pendiente', 'En Espera', 'Completado', 'Cancelado']
    > &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::driver-review.driver-review': ApiDriverReviewDriverReview;
